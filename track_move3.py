...
def process_files(directory, min_x_wavelengths=7, time_start_ns=0, time_end_ns=np.inf):
...
def find_two_linear_fits(times, x_positions):
    ...
    for split_index in range(10, len(times) - 10):
        ...
        # Combine the R² values (you could use a weighted sum if needed)
...
if __name__ == "__main__":
    directory = '/cluster/home/mauricec/simulations/FeGe_7x7_10x6p5_res32_openBC_demag_uni010_run50ns.out'
    output_directory = '/cluster/home/mauricec/simulations'
    file_suffix = 'FeGe_7x7_10x6p5_res32_openBC_demag_uni010_run50ns'
    ...
    if apply_two_linear_fits:
        ...
        print(f"Best fit slopes (velocities): {best_fit_slopes[0]:.2f} nm/ns and {best_fit_slopes[1]:.2f} nm/ns with combined R² = {best_r_squared_total:.2f}")
        ...
        print(f"Best fit slope (velocity) = {best_fit_slope:.2f} nm/ns with R² = {best_fit_r_squared:.2f}")
